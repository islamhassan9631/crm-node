...
router.route("/project/:projectid/buildings/:buildingid/build/:buildid/floors/:floorid/units/:unitid").get(Build.getunit).delete(Build.deletunit).patch(Build.updateunit)
